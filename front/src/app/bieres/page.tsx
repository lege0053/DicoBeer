            ...
            <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                ...
                <div className="px-5 pb-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    </div>                        <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Voir plus</a>
                  </div>
                </div>
            </div>
          </li>
