...
<section className="bg-white">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            ...
            <p className="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl">Page non trouvé</p>
            <p className="mb-4 text-lg font-light text-gray-500">Désolé, nous ne trouvons pas cette page. Vous trouverez beaucoup de choses à explorer sur la page d'accueil. </p>
